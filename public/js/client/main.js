...
const getCategoriesReq = new XMLHttpRequest();

getCategoriesReq.open('POST', localApi+'getCategories')
getCategoriesReq.send();

getCategoriesReq.addEventListener('load', function (){
