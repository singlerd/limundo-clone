    ...
    <div class="row">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            <label for="street" class="col-md-4 col-form-label text-md-right">{{ __('Ulica i broj: ') }}</label>
                        ...
                        <div class="form-group row">
                            <label for="email" class="col-md-4 col-form-label text-md-right">{{ __('Opština:') }}</label>
                        ...
                        <div class="form-group row">
                            <label for="username" class="col-md-4 col-form-label text-md-right">{{ __('Izaberite korisničko ime') }}</label>
                        ...
                        <div class="form-group row">
                            <label for="password" class="col-md-4 col-form-label text-md-right">{{ __('Izaberite lozinku') }}</label>
        ...
        <div class="col-4 pt-5">
            <div class="card">
                ...
                <div class="card-body">
                    “Želim Vam puno sreće u budućem radu, sajt vam je predivan, pronaći i kupiti puno predivnih stvari na jednom mestu iz fotelje bez gubljenja vremena, samo tako nastavite, divni ste, pozdrav i vama od mene.”
                    <div class="text-right">Ime Prezime</div>
                </div>
